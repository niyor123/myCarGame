package com.company.projects.CarGame;
...
public class CarGame extends JFrame implements KeyListener,ActionListener
{
    ...
    public void paint(Graphics g)
    {
        ...
        tree1 = new ImageIcon(ClassLoader.getSystemResource("projects icons/icons/tree1.png"));
        tree1.paintIcon(this, g, 0, tree1ypos);
        num1=random.nextInt(500);
        tree1ypos+=50;

        tree2=new ImageIcon(ClassLoader.getSystemResource("projects icons/icons/tree2.png"));
        tree2.paintIcon(this, g, 0,tree2ypos );
        tree2ypos+=50;

        tree3=new ImageIcon(ClassLoader.getSystemResource("projects icons/icons/tree3.png"));
        ...
        car=new ImageIcon(ClassLoader.getSystemResource("projects icons/icons/gamecar1.png"));
        ...
        car1=new ImageIcon (ClassLoader.getSystemResource("projects icons/icons/gamecar2.png"));
        car2=new ImageIcon(ClassLoader.getSystemResource("projects icons/icons/gamecar3.png"));
        car3=new ImageIcon(ClassLoader.getSystemResource("projects icons/icons/gamecar4.png"));
